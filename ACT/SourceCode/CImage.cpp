...
//画像を透過+画像回転して表示する関数
void CImage::TransSpinBlt(double xDest, double  yDest,
	double  wDest, double  hDest,
	int xSrc, int ySrc, int C)
{
	...
	PlgBlt(m_hWorkDC, po, m_hMemDC, wDest * xSrc, 0, wDest, hDest, NULL, 0, 0);
...
void CImage::TransSpinAlBlt(double xDest, double yDest, double wDest, double hDest, int xSrc, int ySrc, int wSrc, int hSrc, int C, int Alpha)
{
	...
	PlgBlt(m_hWorkDC2, po, m_hMemDC, xSrc, ySrc, wSrc, hSrc, NULL, 0, 0);
